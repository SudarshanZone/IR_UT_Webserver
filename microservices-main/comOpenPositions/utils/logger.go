...
func InitLogger() {
	...
	logDir := filepath.Join("../", "logs", "comOpenPositions")
	...
	infoLogPath := filepath.Join(logDir, "comOpenPositions-"+date+"-info.log")
	errorLogPath := filepath.Join(logDir, "comOpenPositions-"+date+"-error.log")
	debugLogPath := filepath.Join(logDir, "comOpenPositions-"+date+"-debug.log")
