...
func InitLogger() {
	...
	logDir := filepath.Join("../", "logs", "userlogin")
	...
	infoLogPath := filepath.Join(logDir, "userlogin-"+date+"-info.log")
	errorLogPath := filepath.Join(logDir, "userlogin-"+date+"-error.log")
	debugLogPath := filepath.Join(logDir, "userlogin-"+date+"-debug.log")
