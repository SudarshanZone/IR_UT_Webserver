...
func InitLogger() {
	...
	logDir := filepath.Join("../", "logs", "comOrderDetails")
	...
	infoLogPath := filepath.Join(logDir, "comOrderDetails-"+date+"-info.log")
	errorLogPath := filepath.Join(logDir, "comOrderDetails-"+date+"-error.log")
	debugLogPath := filepath.Join(logDir, "comOrderDetails-"+date+"-debug.log")
