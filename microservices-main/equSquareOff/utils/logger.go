...
func InitLogger() {
	...
	logDir := filepath.Join("../", "logs", "equSquareOff")
	...
	infoLogPath := filepath.Join(logDir, "equSquareOff-"+date+"-info.log")
	errorLogPath := filepath.Join(logDir, "equSquareOff-"+date+"-error.log")
	debugLogPath := filepath.Join(logDir, "equSquareOff-"+date+"-debug.log")
